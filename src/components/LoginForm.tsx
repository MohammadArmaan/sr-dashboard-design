...
export function LoginForm({ onLogin }: LoginFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (username === "admin" && password === "pass1234") {
      ...
      toast({
        title: "Welcome back!",
        description: "Successfully logged into SR Events & Portraits CMS",
      });
    } else {
      toast({
        title: "Login Failed",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dashboard-bg via-accent/20 to-primary/5 flex items-center justify-center p-4">
      <motion.div
        ...
        <Card className="bg-gradient-card shadow-lg border-0">
          <CardHeader className="text-center space-y-4">
            <motion.div
              ...
              className="mx-auto w-20 h-20 bg-gradient-primary rounded-full flex items-center justify-center shadow-glow"
            >
          ...
          <CardContent>
            ...
            >
              <p className="text-xs text-muted-foreground">
                Demo Credentials: admin / pass1234
              </p>
            </motion.div>
          </CardContent>
        </Card>
